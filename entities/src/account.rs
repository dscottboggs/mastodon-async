...
pub struct Account {
    ...
    ///
    /// See <https://docs.joinmastodon.org/entities/Account/#header_static>
    pub header_static: Url,
    /// The ID of the account.
    ///
    /// See <https://docs.joinmastodon.org/entities/Account/#id>
    pub id: AccountId,
    /// When the most recent status was posted, or `None` if no statuses.
    ///
...
pub struct CredentialAccount {
    ...
    /// and [update credentials](https://docs.joinmastodon.org/methods/accounts/#update_credentials).
    ///
...
pub struct Source {
    ...
    ///
    /// See <https://docs.joinmastodon.org/entities/Account/#source-privacy>
    pub privacy: Option<crate::visibility::Visibility>,
    /// Whether new statuses should be marked sensitive by default.
    ///
    /// See <https://docs.joinmastodon.org/entities/Account/#source-sensitive>
    #[serde(deserialize_with = "string_or_bool")]
    pub sensitive: bool,
    /// Profile bio, in plain-text instead of in HTML.
    ///
    /// See <https://docs.joinmastodon.org/entities/Account/#source-note>
    pub note: Option<String>,
    /// Metadata about the account.
    ///
    /// See <https://docs.joinmastodon.org/entities/Account/#source-fields>
    pub fields: Option<Vec<MetadataField>>,
    /// The default posting language for new statuses.
    ///
    /// See <https://docs.joinmastodon.org/entities/Account/#source-language>
    pub language: Option<String>,
    /// The number of pending follow requests.
    ///
    /// See <https://docs.joinmastodon.org/entities/Account/#follow_requests_count>
...
#[deprecated = "This type has been removed from the upstream API and will be removed from this library in v2.0"]
...
pub struct Role {
    ...
    ///
    /// See <https://docs.joinmastodon.org/entities/Role/#id>
    pub id: i64,
    /// The name of the role.
    ///
    /// See <https://docs.joinmastodon.org/entities/Role/#name>
    pub name: String,
    /// The hex code assigned to this role. If no hex code is assigned, the
    /// string will be empty.
    ///
    /// See <https://docs.joinmastodon.org/entities/Role/#color>
    pub color: Color,
    /// An index for the role’s position. The higher the position, the more
    /// priority the role has over other roles.
    ///
    /// See <https://docs.joinmastodon.org/entities/Role/#position>
    pub position: i64,
    /// A bitmask that represents the sum of all permissions granted to the
    /// role.
    ///
    /// See <https://docs.joinmastodon.org/entities/Role/#permissions> and
    ...
    ///
    /// See <https://docs.joinmastodon.org/entities/Role/#highlighted>
    pub highlighted: bool,
    /// The date that the role was created
    ///
    /// See <https://docs.joinmastodon.org/entities/Role/#created_at>
    #[serde(with = "iso8601")]
    pub created_at: OffsetDateTime,
    /// The date that the role was updated.
    ///
    /// See <https://docs.joinmastodon.org/entities/Role/#updated_at>
    #[serde(with = "iso8601")]
